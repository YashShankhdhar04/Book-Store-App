      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> yashshankhdhar05@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +91 7668517226
            </p>
            <p>
              <i className="fa fa-home mr-3" /> IIT ,Bhubaneshwar
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
